...
[![Build Status](https://travis-ci.org/stretchr/testify.svg)](https://travis-ci.org/stretchr/testify) [![Go Report Card](https://goreportcard.com/badge/github.com/denist-huma/testify/v2)](https://goreportcard.com/report/github.com/denist-huma/testify/v2) [![PkgGoDev](https://pkg.go.dev/badge/github.com/denist-huma/testify/v2)](https://pkg.go.dev/github.com/denist-huma/testify/v2)
...
[`assert`](http://godoc.org/github.com/denist-huma/testify/v2/assert "API documentation") package
-------------------------------------------------------------------------------------------
...
[`require`](http://godoc.org/github.com/denist-huma/testify/v2/require "API documentation") package
---------------------------------------------------------------------------------------------
...
[`mock`](http://godoc.org/github.com/denist-huma/testify/v2/mock "API documentation") package
----------------------------------------------------------------------------------------
...
import (
  "testing"
  "github.com/denist-huma/testify/v2/mock"
)
...
For more information on how to write mock code, check out the [API documentation for the `mock` package](http://godoc.org/github.com/denist-huma/testify/v2/mock).
...
This will then make the following packages available to you:
    ...
    github.com/denist-huma/testify/v2/mock
    github.com/denist-huma/testify/v2/suite
    github.com/denist-huma/testify/v2/http (deprecated)
