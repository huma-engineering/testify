...
var (
	pkg       = flag.String("assert-path", "github.com/denist-huma/testify/v2/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/denist-huma/testify/v2/_codegen
